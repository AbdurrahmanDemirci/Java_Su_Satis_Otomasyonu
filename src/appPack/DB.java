...
public class DB {
   ...
   final private String driver = "com.mysql.jdbc.Driver"; // msql baglanmak için bir libel edinmek gerekir solda libreal de ekliyoruz.
   ...
   private String dbName = "suSatisOtomasyon"; // myqsl de oluşturudugumuz yerin adı proje
   ...
   private PreparedStatement pst = null;
    ...
    public Statement baglan() {
        try {
            ...
            System.out.println("BAGLANTI BAŞARILI");
        } catch (Exception e) {
